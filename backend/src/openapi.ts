export const openapi = {
  ...
  paths: {
    ...
    '/users/me/privacy': { patch: { summary: 'Update privacy consent', responses: { '200': { description: 'Updated' } } } },
    ...
    '/locations/batch': { post: { summary: 'Store a batch of GPS samples', responses: { '202': { description: 'Accepted' }, '403': { description: 'Consent required' } } } },
