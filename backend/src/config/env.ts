...
const envSchema = z.object({
  ...
  LOCATION_RETENTION_DAYS: z.coerce.number().int().positive().default(1),
  ...
  DEMO_ADMIN_ENABLED: booleanString,
  TRAFFIC_SIMULATION_INTERVAL_MS: z.coerce.number().int().min(500).max(60_000).default(10_000),
