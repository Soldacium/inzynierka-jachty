...
interface Props { ports: Port[]; alerts: Alert[]; traffic: (TrafficPoint | TrafficCell | HistoricalAisCell)[]; route?: SailRoute; activeOverlay: 'route' | 'vessels' | 'traffic' | 'historical' | 'alerts'; focusCoordinate?: [number, number] | null; onBounds: (bounds: MapBounds) => void; selectedPortId: string | null; selectedPortDistance?: number | null; selectedAlertId: string | null; onAlert: (id: string) => void; onPort: (id: string) => void; onPortDetails: (id: string) => void; mapStyleUrl: string }
