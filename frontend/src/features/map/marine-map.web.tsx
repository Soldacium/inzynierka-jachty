...
interface Props { ports: Port[]; alerts: Alert[]; traffic: (TrafficPoint | TrafficCell)[]; route?: SailRoute; activeOverlay: 'route' | 'vessels' | 'traffic' | 'alerts'; focusCoordinate?: [number, number] | null; onBounds: (bounds: MapBounds) => void; onPort: (id: string) => void; mapStyleUrl: string }
